...
>>>>>>> 7e9207ebb2ef1f64c6105d3d581b3132e878021e
...
abline(h = 0, lty = 2)
```
The solid black curve in the plot aboves shows the graph of $f(x)$ versus $x$ for $x \in (-5,5)$. The points where the curve and horizontal line at $f(x) = 0$ intersect are the real-valued solutions to $f(x) = ax^2 + bx + c = 0$. 
